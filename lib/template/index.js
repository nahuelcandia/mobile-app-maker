...
function template(app, templateName) {
  ...
  templateName = (typeof templateName === 'undefined' ? config.get("template") : templateName);
  ...
  debug("Available plugins on template module are: %s", Object.keys(app.plugins).join(", "));
