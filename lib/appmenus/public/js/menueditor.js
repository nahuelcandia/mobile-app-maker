...
menueditor.prototype = {
  ...
  getMenusData: function() {
    ...
    $("#tableTabbar tbody").children().each(function(index) {
      var newMenu = {};
      newMenu.title = $(this).find(".inputTitleTabbar").val();
      newMenu.screenID = $(this).find(".selectScreenIDTabbar").val();
      newMenu.icon = $(this).find(".selectIconTabbar").val();
      newMenu.menu = $('#menuType').val();
