...
function(a, b) {
  ...
  MediumEditor.prototype = {
    ...
    init: function(a, d) {
      return this.options = c(d, this.defaults), this.setElementSelection(a), 0 !== this.elements.length ? (this.parentElements = ["p", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "pre"], this.id = b.querySelectorAll(".medium-editor-toolbar").length + 1, this.setup()) : void 0
    },
    setup: function() {
    ...
    updateElementList: function() {
      this.elements = "string" == typeof this.elementSelection ? this.options.ownerDocument.querySelectorAll(this.elementSelection) : this.elementSelection, 1 === this.elements.nodeType && (this.elements = [this.elements])
    },
    serialize: function() {
      var a, b, c = {};
    ...
    bindTab: function(a) {
      ...
      return this.elements[a].addEventListener("keydown", function(a) {
        if (9 === a.which) {
          var d = g.call(c).tagName.toLowerCase();
          "pre" === d && (a.preventDefault(), b.execCommand("insertHtml", null, "    ")), "li" === d && (a.preventDefault(), a.shiftKey ? b.execCommand("outdent", a) : b.execCommand("indent", a))
        }
      }), this
    },
    buttonTemplate: function(a) {
      var b = this.getButtonLabels(this.options.buttonLabels),
        c = {
          ...
          strikethrough: '<button class="medium-editor-action medium-editor-action-strikethrough" data-action="strikethrough" data-element="strike">' + b.strikethrough + "</button>",
          ...
          justifyCenter: '<button class="medium-editor-action medium-editor-action-justifyCenter" data-action="justifyCenter" data-element="">' + b.justifyCenter + "</button>",
          justifyFull: '<button class="medium-editor-action medium-editor-action-justifyFull" data-action="justifyFull" data-element="">' + b.justifyFull + "</button>",
          justifyLeft: '<button class="medium-editor-action medium-editor-action-justifyLeft" data-action="justifyLeft" data-element="">' + b.justifyLeft + "</button>",
          justifyRight: '<button class="medium-editor-action medium-editor-action-justifyRight" data-action="justifyRight" data-element="">' + b.justifyRight + "</button>"
        };
      return c[a] || !1
    },
    ...
    checkSelection: function() {
      var a, b;
      return this.keepToolbarAlive === !0 || this.options.disableToolbar || (a = this.options.contentWindow.getSelection(), "" === a.toString().trim() || this.options.allowMultiParagraphSelection === !1 && this.hasMultiParagraphs() || this.selectionInContentEditableFalse() ? this.hideToolbarActions() : (b = this.getSelectionElement(), !b || b.getAttribute("data-disable-toolbar") ? this.hideToolbarActions() : this.checkSelectionElement(a, b))), this
    },
    ...
    hasMultiParagraphs: function() {
      var a = h.call(this).replace(/<[\S]+><\/[\S]+>/gim, ""),
    ...
    execAction: function(a, b) {
      a.indexOf("append-") > -1 ? (this.execFormatBlock(a.replace("append-", "")), this.setToolbarPosition(), this.setToolbarButtonStates()) : "anchor" === a ? this.triggerAnchorAction(b) : "image" === a ? this.options.ownerDocument.execCommand("insertImage", !1, this.options.contentWindow.getSelection()) : (this.options.ownerDocument.execCommand(a, !1, null), this.setToolbarPosition())
    },
    ...
    triggerAnchorAction: function() {
      ...
      return a.tagName && "a" === a.tagName.toLowerCase() ? this.options.ownerDocument.execCommand("unlink", !1, null) : "block" === this.anchorForm.style.display ? this.showToolbarActions() : this.showAnchorForm(), this
    },
    ...
    saveSelection: function() {
      this.savedSelection = e.call(this)
    },
    restoreSelection: function() {
      f.call(this, this.savedSelection)
    },
    ...
    bindAnchorForm: function() {
      var a = this.anchorForm.querySelector("a.medium-editor-toobar-anchor-close"),
        b = this.anchorForm.querySelector("a.medium-editor-toobar-anchor-save"),
        c = this;
      return this.anchorForm.addEventListener("click", function(a) {
        ...
        var b, d = null;
        13 === a.keyCode && (a.preventDefault(), b = c.options.anchorTarget && c.anchorTarget.checked ? "_blank" : "_self", c.options.anchorButton && c.anchorButton.checked && (d = c.options.anchorButtonClass), c.createLink(this, b, d))
        ...
        a.stopPropagation(), c.keepToolbarAlive = !0
      }), this.options.ownerDocument.body.addEventListener("click", function(a) {
        a.target === c.anchorForm || d(c.anchorForm, a.target) || d(c.toolbarActions, a.target) || (c.keepToolbarAlive = !1, c.checkSelection())
      }, !0), this.options.ownerDocument.body.addEventListener("focus", function(a) {
        a.target === c.anchorForm || d(c.anchorForm, a.target) || d(c.toolbarActions, a.target) || (c.keepToolbarAlive = !1, c.checkSelection())
      }, !0), a.addEventListener("click", function(a) {
        a.preventDefault(), c.showToolbarActions(), f.call(c, c.savedSelection)
      }), this
    },
    ...
    showAnchorPreview: function(a) {
      ...
      var b, c, d, e = this,
        ...
        h = (g.left + g.right) / 2;
      return e.anchorPreview.querySelector("i").textContent = a.href, b = e.anchorPreview.offsetWidth / 2, c = e.options.diffLeft - b, clearTimeout(d), d = setTimeout(function() {
        e.anchorPreview && !e.anchorPreview.classList.contains("medium-editor-anchor-preview-active") && e.anchorPreview.classList.add("medium-editor-anchor-preview-active")
      }, 100), e.observeAnchorPreview(a), e.anchorPreview.classList.add("medium-toolbar-arrow-over"), e.anchorPreview.classList.remove("medium-toolbar-arrow-under"), e.anchorPreview.style.top = Math.round(f + g.bottom - e.options.diffTop + this.options.contentWindow.pageYOffset - e.anchorPreview.offsetHeight) + "px", e.anchorPreview.style.left = b > h ? c + b + "px" : this.options.contentWindow.innerWidth - h < b ? this.options.contentWindow.innerWidth + c - b + "px" : c + h + "px", this
    },
    ...
    createAnchorPreview: function() {
      ...
      return b.id = "medium-editor-anchor-preview-" + this.id, b.className = "medium-editor-anchor-preview", b.innerHTML = this.anchorPreviewTemplate(), this.options.elementsContainer.appendChild(b), b.addEventListener("click", function() {
    ...
    anchorPreviewClickHandler: function() {
      if (this.activeAnchor) {
        ...
        b.selectNodeContents(a.activeAnchor), c.removeAllRanges(), c.addRange(b), setTimeout(function() {
    ...
    createLink: function(a, b, c) {
      ...
      if (f.call(this, this.savedSelection), this.options.checkLinkFormat && (a.value = this.checkLinkFormat(a.value)), this.options.ownerDocument.execCommand("createLink", !1, a.value), (this.options.targetBlank || "_blank" === b) && this.setTargetBlank(), c && this.setButtonClass(c), this.options.targetBlank || "_blank" === b || c)
    ...
    bindWindowActions: function() {
      ...
      return this.windowResizeHandler = function() {
        clearTimeout(a), a = setTimeout(function() {
          b.toolbar && b.toolbar.classList.contains("medium-editor-toolbar-active") && b.setToolbarPosition()
        }, 100)
      }, this.options.contentWindow.addEventListener("resize", this.windowResizeHandler), this
    },
    activate: function() {
    ...
    bindPaste: function() {
      ...
      for (this.pasteWrapper = function(a) {
        ...
        if (a.clipboardData && a.clipboardData.getData && !a.defaultPrevented) {
          if (a.preventDefault(), b.options.cleanPastedHTML && a.clipboardData.getData("text/html")) return b.cleanPaste(a.clipboardData.getData("text/html"));
          if (b.options.disableReturn || this.getAttribute("data-disable-return")) e = b.htmlEntities(a.clipboardData.getData("text/plain")), b.options.ownerDocument.execCommand("insertHTML", !1, e);
          else {
            for (c = a.clipboardData.getData("text/plain").split(/[\r\n]/g), d = 0; d < c.length; d += 1) "" !== c[d] && (e += navigator.userAgent.match(/firefox/i) && 0 === d ? b.htmlEntities(c[d]) : "<p>" + b.htmlEntities(c[d]) + "</p>");
            b.options.ownerDocument.execCommand("insertHTML", !1, e)
          }
        }
    ...
    cleanupSpans: function(a) {
      ...
      for (e = a.querySelectorAll("span"), b = 0; b < e.length; b += 1) c = e[b], /^\s*$/.test() ? c.parentNode.removeChild(c) : c.parentNode.replaceChild(this.options.ownerDocument.createTextNode(c.innerText), c)
    }
  }
}(window, document);